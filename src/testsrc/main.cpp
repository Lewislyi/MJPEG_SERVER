...
//jpegEncode
//////////////////////////////////////////////////////
void jpegEncode(FILE* dest, uint8_t* rgb, uint32_t width, uint32_t height, int quality)  
{  
  JSAMPARRAY image;  
...
static int read_frame (void)
{
 ...
 unsigned char* rgb =  
        yuyv2rgb((uint8_t *)buffers[buf.index].start, 320, 240);  
 
 jpegEncode(file_fd, rgb, 320, 240, 100); 
